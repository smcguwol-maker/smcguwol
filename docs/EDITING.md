## 홍보 게시판 추가 안내 (2026-09-22)

홈의 영상·그림 소식은 고객 관리 화면을 사용하도록 변경했습니다. 실제 고객 로그인 활성화는 권한 설정 대기이며, 자세한 사용법과 제작자 설정은 [PROMOTION_BOARD.md](PROMOTION_BOARD.md)를 참고하세요. D1 연결 후 content/site.json의 videos를 수정해도 고객이 저장한 홍보 게시물을 덮어쓰지 않습니다.
