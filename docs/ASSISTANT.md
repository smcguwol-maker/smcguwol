...
2026-09-19 13:29 KST 공식 배포82485a5f에 Production AI / SMC_AI_ENABLED=true를 적용했습니다. 공식 도메인에서 실제 주차·연습 용도 AI 응답과 빈방 문의·비밀번호 미제공 안내, 모바일 위젯 표시를 확인했습니다. Preview도 기존 설정을 유지합니다.
