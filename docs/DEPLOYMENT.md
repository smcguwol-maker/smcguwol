...
## 홍보 게시판 운영 추가 (2026-09-22)

고객 직접 편집을 위한 D1 저장소와 Access 로그인 설정은 [PROMOTION_BOARD.md](PROMOTION_BOARD.md)를 따릅니다. 정적 파일만 교체하여 D1 내용을 지우지 않습니다. 관리자 검수용 로컬 서버는 배포하지 않습니다. 현재 Access 초기 설정은 계정 역할 권한 차단으로 대기 중입니다.
